...
export declare type InstructionParams = Nonce | Memo | WalletInit | Transfer | StakingActivate | StakingDeactivate | StakingWithdraw | AtaInit | TokenTransfer | StakingAuthorize | StakingDelegate;
...
export declare type ValidInstructionTypes = SystemInstructionType | StakeInstructionType | 'Memo' | 'InitializeAssociatedTokenAccount' | 'TokenTransfer';
