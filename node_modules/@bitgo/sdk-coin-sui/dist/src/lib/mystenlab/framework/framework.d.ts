...
declare type ObjectDataFull = SuiObjectResponse | SuiMoveObject;
...
export declare type CoinMetadata = Infer<typeof CoinMetadataStruct>;
/**
...
export declare type DelegationData = SuiMoveObject & {
    dataType: 'moveObject';
...
export declare type DelegationSuiObject = Omit<SuiObjectData, 'data'> & {
    data: DelegationData;
};
