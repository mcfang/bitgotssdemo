...
class Eos extends sdk_core_1.BaseCoin {
    ...
    async recover(params) {
        ...
        if (sdk_core_1.getIsKrsRecovery(params)) {
            sdk_core_1.checkKrsProvider(this, krsProvider);
        }
