 ...
 * Transaction method specific args
 */
export declare type StakeArgsPayee = 'Staked' | 'Stash' | 'Controller' | {
    Account: string;
};
/**
 * Transaction method specific args
 */
export declare type StakeArgsPayeeRaw = {
    controller?: null;
    stash?: null;
    staked?: null;
    account?: string;
 ...
 * Transaction method specific args
 */
export declare type BatchCallObject = {
    callIndex: string;
    args: Record<string, any> | AddProxyBatchCallArgs | AddAnonymousProxyBatchCallArgs | StakeBatchCallArgs | StakeMoreCallArgs;
};
...
export declare type StakeBatchCallPayeeStaked = {
    staked: null;
};
export declare type StakeBatchCallPayeeStash = {
    stash: null;
};
export declare type StakeBatchCallPayeeController = {
    controller: null;
};
export declare type StakeBatchCallPayeeAccount = {
    account: string;
};
export declare type StakeBatchCallPayee = StakeBatchCallPayeeStaked | StakeBatchCallPayeeStash | StakeBatchCallPayeeController | StakeBatchCallPayeeAccount;
 ...
 * Transaction method specific args
 */
export declare type ProxyCallArgs = {
    callIndex: string;
    args: TransferArgs;
};
/**
