 ...
 */
export declare function offerUserToBitgoRShare(bitgo: BitGoBase, walletId: string, txRequestId: string, userSignShare: SignShare, encryptedSignerShare: string, apiMode?: 'full' | 'lite', vssProof?: string, privateShareProof?: string, userPublicGpgKey?: string, publicShare?: string): Promise<void>;
/**
