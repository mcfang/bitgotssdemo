...
import { IBaseCoin, Message, SignedMessage, SignedTransaction, TransactionPrebuild, VerificationOptions, TypedData } from '../baseCoin';
...
export declare type ApiVersion = 'lite' | 'full';
...
export declare type WalletType = 'backing' | 'cold' | 'custodial' | 'custodialPaired' | 'hot' | 'trading';
export declare type SubWalletType = 'distributedCustody';
