...
class Ecdsa {
    ...
    async keyShare(index, threshold, numShares, seed, sync = false) {
        ...
        const u = (_a = (secretKey && secretKey.privateKey && util_1.bigIntFromU8ABE(new Uint8Array(secretKey.privateKey)))) !== null && _a !== void 0 ? _a : Ecdsa.curve.scalarRandom();
        const y = Ecdsa.curve.basePointMult(u);
        const chaincode = (_b = (secretKey && secretKey.chainCode)) !== null && _b !== void 0 ? _b : crypto_1.randomBytes(32);
    ...
    keyCombine(pShare, nShares) {
        ...
        const proofContext = crypto_1.createHash('sha256').update(util_1.bigIntToBufferBE(y, Ecdsa.curve.pointBytes)).digest();
    ...
    keyDerive(pShare, nShares, path) {
        ...
        // Generate Schnorr proof of knowledge of the discrete log of X = xG.
        const X = Ecdsa.curve.basePointMult(x);
        const proofContext = crypto_1.createHash('sha256').update(util_1.bigIntToBufferBE(subkey.pk, Ecdsa.curve.pointBytes)).digest();
        const schnorrProofX = sdk_lib_mpc_1.Schnorr.createSchnorrProof(X, x, Ecdsa.curve, proofContext);
        const P_i = {
            i: pShare.i,
            l: pShare.l,
    ...
    sign(M, oShare, dShare, hash, shouldHash = true) {
        ...
        const comDecom_V_A = sdk_lib_mpc_1.HashCommitment.createCommitment(Buffer.concat([util_1.bigIntToBufferBE(V, Ecdsa.curve.pointBytes), util_1.bigIntToBufferBE(A, Ecdsa.curve.pointBytes)]));
        return {
            i: oShare.i,
            y: oShare.y,
            R: pointR.toHex(true),
    ...
    generateVAProofs(M, vaShare) {
        const s = sdk_lib_mpc_1.hexToBigInt(vaShare.s);
        const R = util_1.bigIntFromU8ABE(secp.Point.fromHex(vaShare.R).toRawBytes(true));
        const proofContext = crypto_1.createHash('sha256').update(M).update(util_1.bigIntToBufferBE(R, Ecdsa.curve.pointBytes)).digest();
    ...
    verifyVAShares(vaShare, publicVAShares) {
        publicVAShares.forEach((publicVAShare) => {
            if (!sdk_lib_mpc_1.HashCommitment.verifyCommitment(publicVAShare.comDecomVA.commitment, {
                secret: Buffer.concat([
                    util_1.bigIntToBufferBE(publicVAShare.V, Ecdsa.curve.pointBytes),
                    util_1.bigIntToBufferBE(publicVAShare.A, Ecdsa.curve.pointBytes),
                ]),
            ...
            if (!sdk_lib_mpc_1.EcdsaZkVProof.verifyZkVProof(publicVAShare.V, publicVAShare.zkVProofV, sdk_lib_mpc_1.hexToBigInt(vaShare.R), Ecdsa.curve, vaShare.proofContext)) {
                throw new Error('Could not verify ZK proof of V_i');
            }
        });
        const y = sdk_lib_mpc_1.hexToBigInt(vaShare.y);
        // r is R's x coordinate.  R is in compressed form, so we need to slice off the first byte.
        const r = sdk_lib_mpc_1.hexToBigInt(vaShare.R.slice(2));
        // Calculate aggregation of all V_i and A_i.
        let V = Ecdsa.curve.pointAdd(Ecdsa.curve.pointAdd(Ecdsa.curve.basePointMult(Ecdsa.curve.scalarNegate(util_1.bigIntFromU8ABE(vaShare.m))), Ecdsa.curve.pointMultiply(y, Ecdsa.curve.scalarNegate(r))), vaShare.V);
        let A = vaShare.A;
        publicVAShares.forEach((publicVAShare) => {
        ...
        const comDecom_U_T = sdk_lib_mpc_1.HashCommitment.createCommitment(Buffer.concat([util_1.bigIntToBufferBE(U, Ecdsa.curve.pointBytes), util_1.bigIntToBufferBE(T, Ecdsa.curve.pointBytes)]));
        return {
            ...vaShare,
            U,
            T,
    ...
    verifyUTShares(utShare, publicUTShares) {
        ...
        publicUTShares.forEach((publicUTShare) => {
            if (!sdk_lib_mpc_1.HashCommitment.verifyCommitment(publicUTShare.comDecomUT.commitment, {
                secret: Buffer.concat([
                    util_1.bigIntToBufferBE(publicUTShare.U, Ecdsa.curve.pointBytes),
                    util_1.bigIntToBufferBE(publicUTShare.T, Ecdsa.curve.pointBytes),
                ]),
...
//# sourceMappingURL=data:application/json;base64,